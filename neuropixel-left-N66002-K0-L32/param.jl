...
# --- learning --- #
penlambda   = 0.04  # 1 / learning rate
penlamFF    = 1.0
penmu       = 0.0   # regularize weights
learn_every = 20.0  # (ms)
...
L = 32  # number of plastic weights per neuron
Lexc = L
Linh = L
LX = 0
...
# --- time-varying noise --- #
noise_model=:voltage  # or :voltage
sig = 0.65  # std dev of the Gaussian noise.  can be vector too
